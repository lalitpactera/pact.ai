     ...
     <div id="wrapper">
          <form action="backend.php?task=<?php echo $_GET['task']; ?>" method="post" id="form" enctype="multipart/form-data">
            <ul class="">
                      ...
                      <li>
                            <h3>Upload Data (.wav or .csv)</h3>
                            <p>Enter only one file in .wav or .csv format</p>
                      </li>
                      <li>
                          <input type="file" name="fileToUpload" id="fileToUpload" >
                      </li>
					  					  <li>
                          <p>Enter the text for spell correction, grammar correction and PII (either enter the file or the text below)</p>
                      </li>
                      <li>
                          <textarea name="data" id="" cols="30" rows="5" placeholder="unKnown"></textarea>
                      </li>
                        <li>
